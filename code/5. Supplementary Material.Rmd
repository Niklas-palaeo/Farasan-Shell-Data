...
for (i in 1:length(Species$Site)) {
...
PLOT1+plot_annotation(title= paste0(Species$Site[i],": Species Ranks"),subtitle = "Only names for species with >2% weight percentage displayed" )


ggsave(here(paste0("/Figures and supplementary material/Supplementary Material/3. Species ranks by site/Species_ranks_in_",levels(Aps$Site)[i],".pdf")),height= 10, width = 10)
