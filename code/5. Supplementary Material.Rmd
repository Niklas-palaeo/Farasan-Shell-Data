...
setwd("~/Farasan-Shell-Data-master/results/Supplementary Material/1. Aperture Sizes")#Remember to change the file path
...
setwd("~/Farasan-Shell-Data-master/results/Supplementary Material/2. Site-based Diversity")
...
setwd("~/Farasan-Shell-Data-master/results/Supplementary Material/3. Species ranks by site")
