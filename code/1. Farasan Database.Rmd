...
All .csv files are located in the folder *CSV Exports*. So the first step is to set the working directory to that folder. The file path related to here, is the one for the [virtual computer](https://https://codeocean.com/capsule/0588419/tree) in [Codeocean](https://codeocean.com) DOI:  
When you download the supplementary, the file path below will need to be changed.
